 ...
 * PIDOutput
 */
public class PIDFFController implements IUtility{
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDFFController m_controller;

        public PIDTask(PIDFFController controller) {
            if (controller == null) {
    ...
    protected void calculate() {
        ...
        if (enabled) {
            ...
            synchronized (this) {
                ...
                m_result = m_FF * m_setpoint + (m_P * m_error + m_I * m_totalError + m_D * (m_error - m_prevError));
                m_prevError = m_error;
    ...
    public synchronized double getFF() {
        return m_FF;
    }
